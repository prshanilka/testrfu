...
--
CREATE USER IF NOT EXISTS 'siyalacademy'@'%' IDENTIFIED VIA mysql_native_password USING PASSWORD('siyalacademy');

--
-- Privileges
--
-- (activate this statement if necessary)
GRANT SELECT, INSERT, DELETE, UPDATE, ALTER ON `phpmyadmin`.* TO 'siyalacademy'@'%';
